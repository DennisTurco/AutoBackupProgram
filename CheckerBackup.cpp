...
int main(){
    ...
    //start /min C:\Users\Dennis\eclipse-workspace\AutoBackupProgram\CheckerBackup.exe
    ...
    last_date_in_seconds = last_date_in_seconds;

    cout<< current_date_in_seconds<<endl;
    cout<< last_date_in_seconds<<endl;
    cout<< current_date_in_seconds - last_date_in_seconds<<endl;

    if(current_date_in_seconds - last_date_in_seconds >= 10){ //120 sarebbero 2 minuti e' un valore momentaneo da test
